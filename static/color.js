...
void draw() {
  ...
  if (mouseX > rectX1-colorSquare && mouseX < rectX1+colorSquare &&
      mouseY > rectY1-colorSquare && mouseY < rectY1+colorSquare) {
    overBoxOne = true;
    if(mousePressed) {
  ...
  if (mouseX > rectX2-colorSquare && mouseX < rectX2+colorSquare &&
      mouseY > rectY2-colorSquare && mouseY < rectY2+colorSquare) {
    overBoxOne = true;
    if(mousePressed) {
    ...
    if (mouseX > rectX3-colorSquare && mouseX < rectX3+colorSquare && 
      mouseY > rectY3-colorSquare && mouseY < rectY3+colorSquare) {
    overBoxOne = true;
    if(mousePressed) {
